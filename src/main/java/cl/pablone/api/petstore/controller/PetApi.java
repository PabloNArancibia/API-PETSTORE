...
public interface PetApi {
     ...
     */
    @ApiOperation(value = "Add a new pet to the store", nickname = "addPet", notes = "", response = ModelApiResponse.class, tags={ "pet", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<Pet>> findPetsByStatus(@NotNull @ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "dead, life") @Valid @RequestParam(value = "status", required = true) List<String> status);
